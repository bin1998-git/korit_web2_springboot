...
//        }
    ...
    // Top3 상품들 리턴해주는 메서드(model을 리턴해서는 안됨)
    public List<Top3SellingProductResDto> getTop3SellingProduct() {
        ...
        return outputs;
//                productRepository.findTop3SellingProducts().stream()
//            // 메서드참조로 축약할 수 있다.
...
//            SearchProductResDto resDto = new SearchProductResDto(
